...
class SupervisorStartShift extends StatefulWidget {
  final double? lat;
  final double? lang;
  final String? name;
  SupervisorStartShift({Key? key, this.lat, this.lang, this.name})
      : super(key: key);

  @override
  _SupervisorStartShiftState createState() => _SupervisorStartShiftState();
}

class _SupervisorStartShiftState extends State<SupervisorStartShift> {
  String? clat, clong;
                                                                    ...
                                                                    if (value![index]
                                                                      ...
                                                                      return GestureDetector(
                                                                        onTap:
                                                                            () {
                                                                          print(
                                                                              "Event Id ${value[index]['event_id']}");
                                                                          Event()
                                                                              .sGetTeamDetail(
                                                                            "${value[index]['event_id']}",
                                                                          )
                                                                              .then((useTeamDetails) {
                                                                            print("useTeamDetails ${useTeamDetails}");
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                SizedBox(
                                                                                                  ...
                                                                                                  child: ListView.builder(
                                                                                                    itemCount: useTeamDetails.length,
                                                                                                    itemBuilder: (ctx, index) {
                                                                                                      return GestureDetector(
                                                                                                        onTap: () {
                                                                                                          String tlat = useTeamDetails[index]['latitude'];
                                                                                                          String tlong = "${useTeamDetails[index]['longitude']}";
                                                                                                          var teamId = useTeamDetails[index]['team_id'];
                                                                                                          var radius = Geolocator.distanceBetween(double.parse("$clat"), double.parse("$clong"), double.parse("$tlat"), double.parse("$tlong"));
                                                                                                          if (radius <= 100) {
                                                                                                            print("First Location Validator $teamId");

                                                                                                            DateTime currentDate = new DateTime.now();
                                                                                                            print(currentDate);
                                                                                                            DateTime startDateTime = DateTime.parse(useTeamDetails[0]['start_time']);
                                                                                                            DateTime endDateTime = DateTime.parse(useTeamDetails[0]['end_time']);
                                                                                                            if (startDateTime.isBefore(currentDate) && endDateTime.isAfter(currentDate)) {
                                                                                                              print("$radius \nSecond Time Validator");
                                                                                                              Shifts().start("${value[index]['event_id']}", "$userId", "$clat", "$clong", "$teamId").then((shiftdata) async {
                                                                                                                final SharedPreferences prefs = await SharedPreferences.getInstance();
                                                                                                                print(shiftdata);
                                                                                                                ...
                                                                                                                setState(() {
                                                                                                                  ...
                                                                                                                  eventId = "${value[index]['event_id']}";
                                                                                                                  start = false;
                                                                                                                  scolor = false;
                                                                                                                  loading = false;
                                                                                                                  stopwatch.start();
                                                                                                                  startTime = "Started Shift at ${DateTime.now().hour}:${DateTime.now().minute}:${DateTime.now().second}";
                                                                                                                  prefs.setString("startTime", "$startTime");
                                                                                                                  prefs.setBool("start", start!);
                                                                                                                  prefs.setString("eventId", "$eventId");
                                                                                                                });
                                                                                                                Navigator.pop(context);
                                                                                                                CommonFunctions.showSuccessToast("Shift started successfully!");
                                                                                                                Navigator.pop(context);
                                                                                                              });
                                                                                                            } else {
                                                                                                              CommonFunctions.showErrorDialog("Start Shift Failed", "Do start shift on time", context);
                                                                                                              setState(() {
                                                                                                                loading = false;
                                                                                                              });
                                                                                                            ...
                                                                                                            CommonFunctions.showErrorDialog("Start Shift Failed", "You are out of Zone", context);
                                                                                                            setState(() {
                                                                                                              loading = false;
                                                                                                            });
                                                                                                            print("Sift End Code");
                                                                                                            ...
                                                                                                            child: Row(
                                                                                                              children: [
                                                                                                                ...
                                                                                                                Container(
                                                                                                                  // width: 100,
                                                                                                                  child: Text(
                                                                                                                    "${useTeamDetails[index]['team_name']}",
                            ...
                            onPressed: () async {
                              ...
                              Event()
                                ...
                                Event()
                                  ...
                                  var teamHours = useTeamDetails[0]['team_id'];
                                  var teamend = useTeamDetails[0]['team_id'];
                                  var teamstart = useTeamDetails[0]['team_id'];
